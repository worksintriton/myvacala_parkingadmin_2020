...
module.exports = "<div class=\"\">\r\n  <div class=\"\">\r\n\r\n      <div class=\"login_box\">\r\n          <div class=\"login_box_inner\">\r\n\r\n              <div class=\"container_login_form\">\r\n                  <!-- <div class=\"logo\">\r\n          <img\r\n            src=\"../../../assets/img/brand/logo2.png\"\r\n            alt=\"\">\r\n        </div> -->\r\n                  <div class=\"login_form\">\r\n                      <div _ngcontent-c5=\"\" class=\"col-md-12 grid-margin\">\r\n                          <div _ngcontent-c5=\"\" class=\"card\">\r\n                              \r\n                              <div _ngcontent-c5=\"\" class=\"card-body text-center\">\r\n                                  <div class=\"logo\">\r\n                                      <img src=\"assets/img/avatars/logo-png.png\" alt=\"\">\r\n                                  </div>\r\n\r\n                                  <!-- <h4 _ngcontent-c5=\"\" class=\"card-title\">Login</h4> -->\r\n                                   <div >\r\n                                        <div class=\"text-danger\"></div>\r\n                                       </div>\r\n\r\n                                       <div  *ngIf = \"loginError\" class=\"alert alert-danger alert-dismissible fade show\" role=\"alert\">\r\n                                            {{loginErrorMsg}}\r\n                                          <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\r\n                                            <span aria-hidden=\"true\">&times;</span>\r\n                                          </button>\r\n                                        </div>\r\n                                  <form  class=\"my-form forms-sample ng-untouched ng-pristine ng-valid\">\r\n                                      <div class=\"form-group\">\r\n                                          <label  >Enter Phone Number</label>\r\n                                          <input  \r\n                                              class=\"form-control\"\r\n                                              placeholder=\"Phone Number\"\r\n                                              type=\"text\" name=\"phonenumber\"\r\n                                              [(ngModel)]=\"phonenumber\"  \r\n                                              (ngModelChange)=\"mobileValidator(phonenumber)\"\r\n                                              >\r\n                                              <div *ngIf=\"phError\">\r\n                                                  <div class=\"text-danger\">{{phErrorMsg}}</div>\r\n                                              </div>\r\n                                          \r\n                                      </div>\r\n                                      <!-- <div class=\"form-group\">\r\n                                          <label  >Password</label>\r\n                                          <input  \r\n                                              class=\"form-control\"\r\n                                              placeholder=\"Password\"\r\n                                              type=\"password\" \r\n                                              [(ngModel)]=\"password\"                                                \r\n                                              (ngModelChange)=\"passwordChange($event)\" \r\n                                              [ngModelOptions]=\"{standalone: true}\"\r\n                                              >\r\n                                              <div *ngIf=\"passwordError\">\r\n                                                  <div class=\"text-danger\">{{passwordErrorMsg}}</div>\r\n                                              </div>\r\n                                          \r\n                                      </div>\r\n                                       -->\r\n                                    \r\n                                      <button class=\"btn btn-success  mr-2\" (click)=\"onLogin()\">Login</button>\r\n                                  </form>\r\n\r\n                              </div>\r\n                          </div>\r\n                      </div>\r\n                  </div>\r\n              </div>\r\n\r\n          </div>\r\n      </div>\r\n\r\n  </div>\r\n</div>\r\n<div class=\"alert-msgs\" *ngIf=\"alertcon\">\r\n  <div class=\"alert-msg\">\r\n      <div class=\"alert-msg-con\">\r\n\r\n          <div class=\"alert-img\" *ngIf=\"success\">\r\n              <img src=\"assets/img/alert/success.png\" width=\"45px\" alt=\"\">\r\n          </div>\r\n          <div class=\"alert-img\" *ngIf=\"warning\">\r\n              <img src=\"assets/img/alert/waring.png\" width=\"45px\" alt=\"\">\r\n          </div>\r\n          <h4>\r\n              {{alertmsg}}\r\n          </h4>\r\n          <p>{{alertcont}}</p>\r\n\r\n          <button class=\"alert-btn {{button}}\" type=\"button\" (click)=\"hidealert()\"> ok </button>\r\n      </div>\r\n  </div>\r\n</div>\r\n<script>\r\n  // Automatically trigger the loading animation on click\r\nLadda.bind('button[type=submit]');\r\n\r\n// Same as the above but automatically stops after two seconds\r\nLadda.bind('button[type=submit]', { timeout: 2000 } );\r\n\r\n</script>\r\n"
...
var ApiService = /** @class */ (function () {
    function ApiService(http) {
        ...
        this.imgUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].imageURL;
    }
    ApiService.prototype.CreateDoctor = function (data) {
        return this.http.post(this.apiUrl + 'user/register', data);
    };
    ApiService.prototype.CreateDoctor1 = function (data) {
        return this.http.post(this.apiUrl + 'doctor/edit', data);
    };
    ApiService.prototype.DoctorList = function () {
        return this.http.get(this.apiUrl + 'doctor/getlist');
    };
    ApiService.prototype.DeleteDoctor = function (data) {
        return this.http.delete(this.apiUrl + 'doctor/delete/' + data);
    };
    ApiService.prototype.UserList = function () {
        return this.http.get(this.apiUrl + 'user/getlist');
    };
    ApiService.prototype.DeleteUser = function (data) {
        return this.http.delete(this.apiUrl + 'user/delete/' + data);
    };
    ApiService.prototype.PatientList = function () {
        return this.http.get(this.apiUrl + 'getlist');
    };
    ApiService.prototype.DeletePatient = function (data) {
        return this.http.delete(this.apiUrl + 'delete/' + data);
    };
    ApiService.prototype.GetFamilyList = function (data) {
        return this.http.post(this.apiUrl + 'family/getlist', data);
    };
    ApiService.prototype.DeleteMembers = function (data) {
        return this.http.post(this.apiUrl + 'family/delete', data);
    };
    ApiService.prototype.specializationList = function () {
        return this.http.get(this.apiUrl + 'specialization/getlist');
    };
    ApiService.prototype.Createspecialization = function (data) {
        return this.http.post(this.apiUrl + 'specialization/create', data);
    };
    ApiService.prototype.DeleteSpecialisation = function (data) {
        return this.http.post(this.apiUrl + 'specialization/delete', data);
    };
    ApiService.prototype.Banner_List = function () {
        return this.http.get(this.apiUrl + 'homebanner/getlist');
    };
    ApiService.prototype.CreateBanner = function (data) {
        return this.http.post(this.apiUrl + 'homebanner/create', data);
    };
    ApiService.prototype.DeleteBanner = function (data) {
        return this.http.delete(this.apiUrl + 'homebanner/delete/' + data);
    };
    ApiService.prototype.Symptoms_list = function () {
        return this.http.get(this.apiUrl + 'symptoms/getlist');
    };
    ApiService.prototype.CreateSymptoms = function (data) {
        return this.http.post(this.apiUrl + 'symptoms/create', data);
    };
    ApiService.prototype.deleteSymptoms = function (data) {
        return this.http.post(this.apiUrl + 'symptoms/delete', data);
    };
    ApiService.prototype.editSymptoms = function (data) {
        return this.http.post(this.apiUrl + 'symptoms/edit', data);
    };
    ApiService.prototype.loginprocess = function (data) {
        return this.http.post(this.apiUrl + 'mechanicweb/login', data);
    };
    ApiService.prototype.otpvalidationapi = function (data) {
    ...
    // }
    ApiService.prototype.BookingList = function (data) {
        return this.http.post(this.apiUrl + 'mechanicweb/bookinglist', data);
    };
    ApiService.prototype.getpickupboylist = function (data) {
        return this.http.post(this.apiUrl + 'pickupboy/mobilelist', data);
    };
    ApiService.prototype.deletepickupboy_list = function (i) {
        return this.http.delete('http://3.101.31.129:3000/pickupboy/delete', i);
    };
    ApiService.prototype.editpickupboycreate = function (data) {
        return this.http.put('http://3.101.31.129:3000/pickupboy/editdetails', data);
    };
    ApiService.prototype.getpickupboycreate = function (data) {
        return this.http.post(this.apiUrl + 'pickupboy/create', data);
    };
    ApiService.prototype.editpickupboy = function (data) {
        return this.http.post(this.apiUrl + 'pickupboy/editdetails', data);
    };
    ApiService.prototype.DoctorListlets = function () {
    ...
    ApiService.prototype.Parking_Detail_by_id = function (data) {
        return this.http.post(this.apiUrl + 'parking/parkingareadetails/getlist', data);
    };
    ApiService.prototype.vendor_qrcode_list = function (data) {
        return this.http.post(this.apiUrl + 'parking/parkingareadetails/qrgetlist_vendor_id', data);
    };
    ApiService.prototype.parking_bookinglist = function (data) {
    ...
    ApiService.prototype.payment_list = function (data) {
        return this.http.post(this.apiUrl + 'parking/parkingbooking/getlist_vendor_id', data);
    };
...
/* harmony import */ var _views_buttons_otpvalidation_otpvalidation_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./views/buttons/otpvalidation/otpvalidation.component */ "./src/app/views/buttons/otpvalidation/otpvalidation.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            declarations: [
                ...
                _views_buttons_otpvalidation_otpvalidation_component__WEBPACK_IMPORTED_MODULE_16__["OtpvalidationComponent"]
            ]),
            providers: [{
...
/* harmony import */ var _views_buttons_otpvalidation_otpvalidation_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/buttons/otpvalidation/otpvalidation.component */ "./src/app/views/buttons/otpvalidation/otpvalidation.component.ts");
...
var routes = [
    ...
    {
        path: 'OTPValidation',
        component: _views_buttons_otpvalidation_otpvalidation_component__WEBPACK_IMPORTED_MODULE_8__["OtpvalidationComponent"],
        data: {
            title: 'Login Page'
        }
    },
    {
        ...
        children: [
            ...
            {
                path: 'theme',
                loadChildren: function () { return __webpack_require__.e(/*! import() | views-theme-theme-module */ "views-theme-theme-module").then(__webpack_require__.bind(null, /*! ./views/theme/theme.module */ "./src/app/views/theme/theme.module.ts")).then(function (m) { return m.ThemeModule; }); }
            },
            {
                path: 'widgets',
                loadChildren: function () { return __webpack_require__.e(/*! import() | views-widgets-widgets-module */ "views-widgets-widgets-module").then(__webpack_require__.bind(null, /*! ./views/widgets/widgets.module */ "./src/app/views/widgets/widgets.module.ts")).then(function (m) { return m.WidgetsModule; }); }
            }
        ]
    },
...
var DefaultLayoutComponent = /** @class */ (function () {
    ...
    DefaultLayoutComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./default.css */ "./src/app/containers/default-layout/default.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(_angular_common__WEBPACK_IMPORTED_MODULE_2__["DOCUMENT"])),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](2, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_5__["SESSION_STORAGE"])),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [Object, _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], Object])
...
/***/ "./src/app/containers/default-layout/default.css":
/*!*******************************************************!*\
  !*** ./src/app/containers/default-layout/default.css ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = ":host::ng-deep .app-header .navbar-toggler {\r\n    display: none !important;\r\n}\r\n.park-name{\r\n    font-size: 13px;\r\n    text-align: left;\r\n    margin-top: 10px;\r\n    margin-bottom: 0px;\r\n    color: #2196f3;\r\n}\r\n.logout{\r\n    font-size: 15px !important;\r\n    font-weight: 600 !important;\r\n    color: #fd0000;\r\n}\r\n:host::ng-deep  .app-header .navbar-brand {\r\n    margin-bottom: 10px !important;\r\n}\r\n.bage {\r\n    position: absolute;\r\n    top: -8px;\r\n    right: 8px;\r\n    font-size: 10px !important;\r\n    border-radius: 50%;\r\n    background-color: red;\r\n    color: white;\r\n    line-height: 1.5;\r\n    font-family: \"Helvetica Neue\", sans-serif !important;\r\n    padding: 1px 5px;\r\n\r\n  }\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
/***/ "./src/app/views/buttons/otpvalidation/otpvalidation.component.scss":
/*!**************************************************************************!*\
  !*** ./src/app/views/buttons/otpvalidation/otpvalidation.component.scss ***!
  \**************************************************************************/
/*! no static exports found */
...
module.exports = ".login_box {\n  position: relative;\n  top: 0px;\n  width: 100%;\n  height: 100vh;\n  max-height: 100vh;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: #f1f1f1;\n  background-image: url('hiring-Mobile-Mechanics.jpg');\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n}\n\n.login_box_inner {\n  display: contents;\n  background-color: #fff;\n  padding: 50px;\n  border-radius: 8px;\n  box-shadow: 0px 0px 10px 0px #dadada;\n}\n\n.form-control {\n  border: 1px solid #323b92;\n}\n\n.login_form {\n  margin: 10px 0px;\n}\n\n.card .card-body {\n  text-align: left !important;\n}\n\n.form-control {\n  width: 300px !important;\n}\n\n.logo img {\n  margin: 0px 0px 24px 32%;\n  width: 100px;\n}\n\n.justify-center {\n  display: flex;\n  justify-content: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/views/buttons/otpvalidation/otpvalidation.component.ts":
/*!************************************************************************!*\
  !*** ./src/app/views/buttons/otpvalidation/otpvalidation.component.ts ***!
  \************************************************************************/
/*! exports provided: OtpvalidationComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OtpvalidationComponent", function() { return OtpvalidationComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var OtpvalidationComponent = /** @class */ (function () {
    function OtpvalidationComponent(router, http, _api, storage) {
        this.router = router;
        this.http = http;
        this._api = _api;
        this.storage = storage;
    ...
    OtpvalidationComponent.prototype.ngOnInit = function () {
        this.OTP = this.getFromLocal("OTP");
        this.ph = this.getFromLocal("phone");
        console.log(this.ph);
    };
    OtpvalidationComponent.prototype.otpvalidation = function () {
        var otp = this.OTP;
        console.log(otp);
    ...
    OtpvalidationComponent.prototype.saveInLocal = function (key, val) {
        this.storage.set(key, val);
    };
    OtpvalidationComponent.prototype.getFromLocal = function (key) {
        return this.storage.get(key);
    };
    OtpvalidationComponent.prototype.resend = function () {
        var ph = {
            "owner_pri_contact": this.ph
        };
        this._api.Login(ph).subscribe(function (response) {
            console.log("response");
            console.log(response);
    ...
    OtpvalidationComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
        { type: _api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_5__["SESSION_STORAGE"],] }] }
    ]; };
    OtpvalidationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-otpvalidation',
            template: __webpack_require__(/*! raw-loader!./otpvalidation.component.html */ "./node_modules/raw-loader/index.js!./src/app/views/buttons/otpvalidation/otpvalidation.component.html"),
            styles: [__webpack_require__(/*! ./otpvalidation.component.scss */ "./src/app/views/buttons/otpvalidation/otpvalidation.component.scss")]
        }),
...
module.exports = ".login_box {\n  position: relative;\n  top: 0px;\n  width: 100%;\n  height: 100vh;\n  max-height: 100vh;\n  text-align: center;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: #f1f1f1;\n  background-image: url('hiring-Mobile-Mechanics.jpg');\n  background-repeat: no-repeat;\n  background-size: cover;\n  background-position: center;\n}\n\n.login_box_inner {\n  display: contents;\n  background-color: #fff;\n  padding: 50px;\n  border-radius: 8px;\n  box-shadow: 0px 0px 10px 0px #dadada;\n}\n\n.form-control {\n  border: 1px solid #323b92;\n}\n\n.login_form {\n  margin: 10px 0px;\n}\n\n.card .card-body {\n  text-align: left !important;\n}\n\n.form-control {\n  width: 300px !important;\n}\n\n.logo img {\n  margin: 0px 0px 24px 32%;\n  width: 100px;\n}\n\n.justify-center {\n  display: flex;\n  justify-content: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, http, _api, storage) {
        this.router = router;
        this.http = http;
        this._api = _api;
        this.storage = storage;
    ...
    LoginComponent.prototype.emailValidator = function () {
        ...
        var emailcheck = reg.test(this.email);
    ...
    LoginComponent.prototype.mobileValidator = function (data) {
    ...
    LoginComponent.prototype.emailChange = function (data) {
        //console.log(data);
        this.email = data;
        this.emailValidator();
    };
    LoginComponent.prototype.passwordChange = function (data) {
        //console.log(data);
        this.password = data;
        this.passwordValidator();
    };
    LoginComponent.prototype.validator = function () {
        this.emailValidator();
    ...
    LoginComponent.prototype.onLogin = function () {
        ...
        if (this.phError == false) {
            ...
            this._api.Login(ph).subscribe(function (response) {
                ...
                if (response.Code == 200) {
                    alert(response.Message);
                    _this.saveInLocal("parking_detail", response.Data);
                    _this.saveInLocal("OTP", response.OTP);
                    _this.saveInLocal("phone", _this.phonenumber);
                    // this.router.navigate(['Home/buttons/view_bookings']);
                    _this.router.navigate(['OTPValidation']);
                }
                else if (response.Code == 400) {
                    alert(response.Message);
                }
    ...
    LoginComponent.prototype.loginotp = function () {
        var _this = this;
        if (this.phonenumber === '') {
            this.phError = true;
        ...
        this._api.loginprocess(data).subscribe(function (response) {
            ...
            if (response.Code == 300) {
                ...
                console.log(_this.phonenumber, response.Data.OTP);
                _this.saveInLocal('phnumber', _this.phonenumber);
                _this.saveInLocal('otp', response.Data.OTP);
                _this.router.navigate(['OTPValidation']);
            }
        });
    };
    LoginComponent.prototype.saveInLocal = function (key, val) {
        this.storage.set(key, val);
    };
    LoginComponent.prototype.getFromLocal = function (key) {
        return this.storage.get(key);
    };
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"],
            ...
            _api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], Object])
    ], LoginComponent);
...
module.exports = __webpack_require__(/*! D:\MY_OFFICE\myvacala_parkingadmin_2020\src\main.ts */"./src/main.ts");
